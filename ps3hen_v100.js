...
var usb_sp='/dev_usb000/stackframe.bin';
	...
	switch (uaStringCheck) {
		case "PLAYSTATION":
			switch (fwVersion) {
				...
				default:
					alert('Your PS3 is not on FW 4.81+! Your current running FW version is ' + fwVersion + ', which is not compatible with ps3hen 1.0. All features have been disabled');
					disable_all();
					break;
			}
			break;
